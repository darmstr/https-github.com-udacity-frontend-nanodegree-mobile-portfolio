  ...
  function changeSliderLabel(size) {
    switch(size) {
      case "1":
        ...
        document.querySelectorAll(".randomPizzaContainer").forEach(function(item) {item.style.width = "292.5px";});
        return;
      case "2":
        document.querySelector("#pizzaSize").innerHTML = "Medium";
        document.querySelectorAll(".randomPizzaContainer").forEach(function(item) {item.style.width = "389.961px";});
        return;
      case "3":
        document.querySelector("#pizzaSize").innerHTML = "Large";
        document.querySelectorAll(".randomPizzaContainer").forEach(function(item) {item.style.width = "585px";});
        return;
      default:
